...
public class ServiceHelper {
    ...
    public void postShareDetails(String url,final IServiceListener listener){
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.networkResponse != null && error.networkResponse.data != null) {
                    ...
                    try {
                        ...
                        JSONObject jsonObject = new JSONObject(responseBody);
                        if(listener != null)
                            listener.onError(jsonObject.getString(HeylaAppConstants.PARAM_MESSAGE));
                    } catch (UnsupportedEncodingException e) {
                        if(listener != null)
                            listener.onError(context.getResources().getString(R.string.error_occurred));
                        e.printStackTrace();
                    } catch (JSONException e) {
                        if(listener != null)
                            listener.onError(context.getResources().getString(R.string.error_occurred));
