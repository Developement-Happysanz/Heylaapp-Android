...
public class CompoundAlertDialogFragment extends DialogFragment {
    ...
    public static CompoundAlertDialogFragment newInstance(String title, String message, String posButton, String negButton, int tag) {
        ...
        args.putString(HeylaAppConstants.ALERT_DIALOG_TITLE, title);
        args.putString(HeylaAppConstants.ALERT_DIALOG_MESSAGE, message);
        args.putString(HeylaAppConstants.ALERT_DIALOG_POS_BUTTON, posButton);
        args.putString(HeylaAppConstants.ALERT_DIALOG_NEG_BUTTON, negButton);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String title = args.getString(HeylaAppConstants.ALERT_DIALOG_TITLE);
        tag = args.getInt(HeylaAppConstants.ALERT_DIALOG_TAG, 0);
        String posButton = args.getString(HeylaAppConstants.ALERT_DIALOG_POS_BUTTON, getActivity().getString(R.string.alert_button_ok));
        String negButton = args.getString(HeylaAppConstants.ALERT_DIALOG_NEG_BUTTON, getActivity().getString(R.string.alert_button_cancel));
