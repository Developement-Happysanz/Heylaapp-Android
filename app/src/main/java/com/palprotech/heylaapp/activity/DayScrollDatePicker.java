...
import com.palprotech.heylaapp.utils.DayViewSliderUtil;
import com.palprotech.heylaapp.R;
import com.palprotech.heylaapp.interfaces.OnChildDateSelectedListener;
import com.palprotech.heylaapp.interfaces.OnDateSelectedListener;
import com.palprotech.heylaapp.interfaces.TitleValueCallback;
...
public class DayScrollDatePicker extends LinearLayout implements TitleValueCallback, OnChildDateSelectedListener {
    ...
    DayScrollDatePickerAdapter mAdapter;
    ...
    private void setAttributeValues(TypedArray a){
        ...
        Drawable background = DayViewSliderUtil.setDrawableBackgroundColor(
                getResources().getDrawable(R.drawable.bg_circle_drawable), baseColor);
        Drawable selectedBackground = DayViewSliderUtil.setDrawableBackgroundColor(
