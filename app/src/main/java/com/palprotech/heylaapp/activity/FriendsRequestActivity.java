...
//        readContacts();
    ...
    private void readContactsMethod() {
            ...
            do {
                ...
                if (Integer.parseInt(cursor.getString(cursor.getColumnIndex(ContactsContract.Contacts.HAS_PHONE_NUMBER))) > 0) {
                    ...
                    while (pCur.moveToNext()) {
                        ...
                        alContactsNumber.add(name+" "+contactNumber);
//                        alContactsName.add(name);
                        break;
                    }
                    pCur.close();
                }
            ...
            int getCountNumber = alContactsNumber.size();
//            int getCountName = alContactsName.size();
        }
    }
