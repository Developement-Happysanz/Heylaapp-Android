...
public class SideDrawerToggle implements DrawerLayout.DrawerListener {

    /**
     * Allows an implementing Activity to return an {@link SideDrawerToggle.Delegate} to use
     * with SideDrawerToggle.
     */
    ...
    private final SideDrawerLayout mSideDrawerLayout;
     ...
     * @param SideDrawerLayout           The DrawerLayout to link to the given Activity's ActionBar
    ...
    public SideDrawerToggle(Activity activity, SideDrawerLayout SideDrawerLayout,
        ...
        this(activity, null, SideDrawerLayout, null, openDrawerContentDescRes,
     ...
     * <p>
     * Please use {@link #SideDrawerToggle(Activity, SideDrawerLayout, Toolbar, int, int)}  if you are
    ...
    <T extends Drawable & DrawerToggle> SideDrawerToggle(Activity activity, Toolbar toolbar,
                                                        SideDrawerLayout SideDrawerLayout, T slider,
                                                        @StringRes int openDrawerContentDescRes,
                                                        @StringRes int closeDrawerContentDescRes) {
        if (toolbar != null) {
        ...
        mSideDrawerLayout = SideDrawerLayout;
    ...
    public void syncState() {
        if (mSideDrawerLayout.isDrawerOpen(GravityCompat.START)) {
        ...
        if (mDrawerIndicatorEnabled) {
            setActionBarUpIndicator((Drawable) mSlider,
                    mSideDrawerLayout.isDrawerOpen(GravityCompat.START) ?
    ...
    private void toggle() {
        if (mSideDrawerLayout.isDrawerVisible(GravityCompat.START)) {
            mSideDrawerLayout.closeDrawer(GravityCompat.START);
        } else {
            mSideDrawerLayout.openDrawer(GravityCompat.START);
        }
    }
    ...
    public void setHomeAsUpIndicator(int resId) {
        ...
        if (resId != 0) {
            indicator = mSideDrawerLayout.getResources().getDrawable(resId);
        }
     ...
     * SideDrawerToggle instance directly as your DrawerLayout's listener, you should call
    ...
    void setActionBarUpIndicator(Drawable upDrawable, int contentDescRes) {
        if (!mWarnedForDisplayHomeAsUp && !mActivityImpl.isNavigationVisible()) {
            Log.w("SideDrawerToggle", "DrawerToggle may not show up because NavigationIcon"
    ...
    private static class HoneycombDelegate implements Delegate {
        ...
        SideDrawerToggleHoneycomb.SetIndicatorInfo mSetIndicatorInfo;
        ...
        public Drawable getThemeUpIndicator() {
            return SideDrawerToggleHoneycomb.getThemeUpIndicator(mActivity);
        }
        ...
        public void setActionBarUpIndicator(Drawable themeImage, int contentDescRes) {
            ...
            mSetIndicatorInfo = SideDrawerToggleHoneycomb.setActionBarUpIndicator(
        ...
        public void setActionBarDescription(int contentDescRes) {
            mSetIndicatorInfo = SideDrawerToggleHoneycomb.setActionBarDescription(
