...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private boolean isFirstRunSignin = true;
    private boolean isFirstRunSignup = true;
    ...
    private int tabBackgroundResId = R.drawable.background_landing_pager_tab;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        //tabTextColor = a.getColor(null, tabTextColor);
    ...
    public void notifyDataSetChanged() {
        ...
        int selectedPos = pager.getCurrentItem();
    ...
    private void addTab(final int position, View tab) {
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                isFirstRunSignup = TransPrefs.getBoolean("isFirstRunSignup", true);
                isFirstRunSignin = TransPrefs.getBoolean("isFirstRunSignin", true);
...
//                dialog.setContentView(R.layout.fragment_sign_in);
//
//
//                if (position == 0) {
//
