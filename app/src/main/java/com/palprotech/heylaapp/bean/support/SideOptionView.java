...
public class SideOptionView extends RelativeLayout {
    ...
    public SideOptionView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SideOptionView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize();
    }

    private void initialize() {
        ViewGroup rootView = (ViewGroup) inflate(getContext(), R.layout.side_view_option, this);
    ...
    private class OptionViewHolder {
        ...
        OptionViewHolder(ViewGroup rootView) {
            mTextViewOption = (TextView) rootView.findViewById(R.id.side_view_option_text);
            mImageViewSelector = (ImageView) rootView.findViewById(R.id.side_view_option_selector);
